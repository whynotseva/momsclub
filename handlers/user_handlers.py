...
🎁 <b>Что ты получаешь:</b>
   ...
   • Или деньги на баланс (10-20% от оплаты) 💰
   • При КАЖДОЙ оплате подруги — ты выбираешь награду! 🔄
   • Неограниченное количество приглашений!

💰 <b>Пример заработка:</b>
Подруга платит 2,000₽/месяц
Твой уровень: Gold (20%)
→ Ты получаешь 400₽ КАЖДЫЙ месяц!

3 подруги × 2,000₽ × 20% = 1,200₽/месяц
Годовой доход: 14,400₽! 🚀
...
Вывод денег от 500₽ на карту или СБП 💳"""
